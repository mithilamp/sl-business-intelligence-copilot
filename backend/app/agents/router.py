...
Available tools:
- knowledge_search: factual or explanatory questions grounded in the document collection.
- business_advisor: recommendations, comparisons, action plans, feasibility questions, or questions with a land report.

Use conversation history to resolve follow-up intent. Choose business_advisor whenever a land report is supplied. Return only the structured decision."""
    ...
    def choose_tool(self, question: str, history: str, has_land_report: bool) -> AgentDecision:
